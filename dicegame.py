...
count_wins = {'Player 1': 0, 'Player 2': 0}
while True: 
    player_scores = {'Player 1': 0, 'Player 2': 0}
        #Commit change #1: Allows user to enter a target score
    ...
    #Commit change #3: Adds score counter
        print("\nCurrent win count:")
        for player, wins in count_wins.items ():
            print(f"{player}: {wins} wins")

        #Commit change #2: Allows user ability to play again
